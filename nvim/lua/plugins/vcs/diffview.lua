...
vim.keymap.set("n", "<leader>gdd", function() toggle_diff("DiffviewOpen") end, { desc = "Git: Diffview" })

vim.keymap.set("n", "<leader>gdf", function() toggle_diff("DiffviewFileHistory") end, { desc = "Git: File History" })

vim.keymap.set(
  "x",
  "<leader>gdf",
  function() toggle_diff("'<,'>DiffviewFileHistory --follow") end,
